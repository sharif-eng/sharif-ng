...
R1 was configured with one interface for the local LAN and another interface for the router-to-router connection.
...
Static routes were configured so that each router could reach the remote LAN.
